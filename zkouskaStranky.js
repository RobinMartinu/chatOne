function loadNameDay(){
    ...
    obj.svatek2 = SVATKY[obj.mesic][obj.den+1];
    obj.hlaska = "Dnes ma svatek: " + obj.svatek;
    obj.hlaska2 = "Zitra bude mit svatek: " + obj.svatek2;
    document.getElementById("svatek").innerText = obj.hlaska;
    document.getElementById("svatek2").innerText = obj.hlaska2;
